...
<html lang="en">
    <head>
        ...
        <!-- Responsive-->
        <link rel="stylesheet" type="text/css" href="{{asset('temp/css/responsive.css')}}">
        <!-- fevicon -->
        <link rel="icon" href="{{asset('temp/images/logo.png')}}" type="image/gif" />
        <!-- Scrollbar Custom CSS -->
        <link rel="stylesheet" type="text/css" href="{{asset('temp/css/jquery.mCustomScrollbar.min.css')}}">
