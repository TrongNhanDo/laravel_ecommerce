<section class="banner_main" style="min-height: 150px;">
         <!-- <div id="banner1" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
               <li data-target="#banner1" data-slide-to="0" class="active">
               </li>
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure><img src="https://www.imgacademy.com/themes/custom/imgacademy/images/helpbox-contact.jpg" alt="#"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
